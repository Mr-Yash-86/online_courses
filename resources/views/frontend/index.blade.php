<x-frontend>
    <!--? slider Area Start-->
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-5">
                                <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                                    <img src="{{ asset('frontend/assets/img/hero/heroman.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Categories Area End -->
        <!--? Count Down Start -->
        <div class="count-down-area pt-90 pb-60 section-bg" data-background="{{ asset('frontend/assets/img/gallery/section_bg01.png')}}">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{ asset('frontend/assets/img/gallery/popular_sub1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{ asset('frontend/assets/img/gallery/popular_sub2.png')}}" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{ asset('frontend/assets/img/gallery/popular_sub3.png')}}" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial pt-65">
                                ...
                                <div class="testimonial-icon mb-45">
                                    <img src="{{ asset('frontend/assets/img/gallery/testimonial.png')}}" class="ani-btn " alt="">
                                </div>
                                    <!-- Testimonial Content -->
